...
Frontend em React (Vite) para o aplicativo News Explorer do bootcamp. Hoje a busca e o login são simulados em memória: as notícias são filtradas de um array estático e a autenticação/salvamento usa estados locais (sem API ou persistência).
